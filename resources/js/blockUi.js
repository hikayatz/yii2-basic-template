...
(function () {
	...
	function setup($) {
		...
		$.growlUI = function (title, message, timeout, onClose) {
			...
			var callBlock = function (opts) {
				...
				$.blockUI({
					...
					fadeOut:
						typeof opts.fadeOut !== "undefined" ? opts.fadeOut : 1000,
					timeout:
						typeof opts.timeout !== "undefined" ? opts.timeout : timeout,
					centerY: false,
					showOverlay: false,
					onUnblock: onClose,
			...
			if (ie6 || expr) {
				...
				$.each(layers, function (i, o) {
					...
					if (i < 2) {
						...
						var top =
							opts.css && opts.css.top ? parseInt(opts.css.top, 10) : 0;
						var expression =
		...
		function center(el, x, y) {
			...
			var t =
				(p.offsetHeight - el.offsetHeight) / 2 - sz(p, "borderTopWidth");
